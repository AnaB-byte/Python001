...
fichero_csv = "36680V1.csv"
fichero_tsv = "36680V1.tsv"


# Nombres de los ficheros a escribir
escribir_csv = '36680V1_csv.csv'
escribir_tsv = '36680V1_tsv.tsv'
...
with open(escribir_csv, 'w', sep=';', encoding='utf-8') as write_csv:
